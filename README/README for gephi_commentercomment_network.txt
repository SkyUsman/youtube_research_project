Name: Annie Vu
Code File: gephi_commentercomment_network
Date: 05/01/2024


DESCRIPTION:

The following instructions will help you setup, run, and operate the "gephi_commentercomment_network" 
...
2. Open the script "gephi_commentercomment_network" from your File Explorer and open in VS Code
3. Define the number of videos to process on Line 125
4. Run the script by pressing the play button ▷ on the top right 
5. The bot-like and spam comments and their statistics will print to the terminal
__________________________________________________________________________________________________________
...
2. Import the CSV Files by going to the Data Laboratory tab at the top
	a. Import Nodes:
		...
		iii. Choose videocommenter_nodes.csv as the file to import
	...
	b. Import Edges:
		Repeat the import process for videocommenter_edges.csv
...
5. Style the Graph:
	...
	c. Under Appearance -> Nodes -> Partition: 
		a. You can select Type and change the colors of the Commenter nodes and then Video nodes 
	           or you can select behavior to change those colors
		b. Click "Apply"
