Name: Annie Vu
Code File: gephi_videocommenter_network
Date: 05/01/2024


DESCRIPTION:

The following instructions will help you setup, run, and operate the "gephi_videocommenter_network" 
...
2. Open the script "gephi_videocommenter_network" from your File Explorer and open in VS Code
3. Define the number of videos to process on Line 71
...
5. Style the Graph:
	...
	c. Under Appearance -> Nodes -> Partition: 
		a. Select Type and change the colors of the Commenter nodes and then Video nodes
		b. Click "Apply"
