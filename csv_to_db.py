...
csv_file_path = 'ahmed_ameer_combined_dataset_updated.csv'  # Replace with your actual CSV file path
...
df.to_sql('ahmed_ameer_combined_dataset_updated.csv', engine, if_exists='append', index=False)
